...
public class LuosimaoDuanxinUtil {
    //短信平台的APIkey
    private static final String DUANXIN_API_KEY = "key-cd21a33f7afb5989bad5881ac098abd1";//需要使用自己的APIkey
    private static final String SPEAK_API_KEY = "key-64fb14e85a54cdedbf39532fccb337d4";//需要使用自己的APIkey
